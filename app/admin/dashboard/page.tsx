...
const [sidebarOpen, setSidebarOpen] = useState(false)
  ...
  <style>{`
    @media (max-width: 768px) {
      ...
      .sidebar-icons { display: flex !important; }
  ...
  {/* Mobile icon bar */}
  <div className="sidebar-icons" style={{ display: 'none', flexDirection: 'column', width: '56px', background: '#0f0f0f', borderRight: '1px solid rgba(201,146,42,0.1)', padding: '0.75rem 0', flexShrink: 0, alignItems: 'center', gap: '0.25rem' }}>
    {tabs.map(t => (
      <button key={t.id} onClick={() => setTab(t.id)} title={t.label} style={{ width: '40px', height: '40px', borderRadius: '0.5rem', border: 'none', cursor: 'pointer', fontSize: '1.1rem', background: tab === t.id ? 'rgba(201,146,42,0.15)' : 'transparent', borderLeft: tab === t.id ? '2px solid #c9922a' : '2px solid transparent' }}>
        {t.icon}
      </button>
    ))}
  </div>
  ...
  {/* Desktop sidebar */}
  <div className="sidebar-full" style={{ display: 'flex', flexDirection: 'column', width: '220px', background: '#0f0f0f', borderRight: '1px solid rgba(201,146,42,0.1)', padding: '1.5rem 1rem', flexShrink: 0 }}>
    {tabs.map(t => (
